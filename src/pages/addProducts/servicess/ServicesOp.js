...
const ServicesOp = () => {
  const services = localStorage.getItem('subCategory')
  ...
  return (
    <div className='sub-opt'>
      <div className='subCat-opt'>
        <select className='subcat-select' value={services}>
      ...
      <div>{automotive && <ServicesInput />}</div>
      <div>{btServices && <ServicesInput />}</div>
      <div>{caServices && <ServicesInput />}</div>
      <div>{child && <ServicesInput />}</div>
      <div>{classes && <ServicesInput />}</div>
      <div>{cleaning && <ServicesInput />}</div>
      <div>{computer && <ServicesInput />}</div>
      <div>{dj && <ServicesInput />}</div>
      <div>{fitness && <ServicesInput />}</div>
      <div>{health && <ServicesInput />}</div>
      <div>{landscaping && <ServicesInput />}</div>
      <div>{legal && <ServicesInput />}</div>
      <div>{logistics && <ServicesInput />}</div>
      <div>{manufacturing && <ServicesInput />}</div>
      <div>{catering && <ServicesInput />}</div>
      <div>{pet && <ServicesInput />}</div>
      <div>{photography && <ServicesInput />}</div>
      <div>{printing && <ServicesInput />}</div>
      <div>{recruitment && <ServicesInput />}</div>
      <div>{repair && <ServicesInput />}</div>
      <div>{tax && <ServicesInput />}</div>
      <div>{travel && <ServicesInput />}</div>
      <div>{wedding && <ServicesInput />}</div>
    </div>
  )
}
